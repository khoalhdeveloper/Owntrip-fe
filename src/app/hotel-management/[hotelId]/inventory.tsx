      ...
      if (res?.data) {
        ...
        res.data.forEach((inv: any) => {
          mappedStats[inv.roomTypeId] = {
            ...
            occupancyRate:
              inv.totalInventory > 0
                ? ((inv.bookedCount / inv.totalInventory) * 100).toFixed(0)
                : 0,
          };
        });
        ...
        {!stats || Object.keys(stats).length === 0 ? (
          <View style={styles.emptyState}>
            ...
            <Text style={styles.emptyDesc}>
              Bấm dấu + ở góc trên để mở bán phòng cho 30 ngày tới.
            </Text>
          </View>
        ) : (
              ...
              <View key={roomTypeId} style={styles.roomCard}>
                <View style={styles.roomHeader}>
                  ...
                  <View
                    style={[
                      styles.badge,
                      rStats.availableRooms === 0 && { backgroundColor: '#FEF2F2' },
                    ]}
                  >
                    <Text
                      style={[
                        styles.badgeText,
                        rStats.availableRooms === 0 && { color: '#EF4444' },
                      ]}
                    >
                      {rStats.availableRooms === 0
                        ? 'Hết phòng'
                        : `Lấp đầy: ${rStats.occupancyRate}%`}
                    </Text>
                  </View>
                </View>
                ...
                <View style={styles.revenueRow}>
                  ...
                  <Text style={styles.revenueText}>
                    Giá bán hôm nay:{' '}
                    <Text style={{ fontWeight: '700' }}>{formatPrice(rStats.price)}đ/đêm</Text>
                  </Text>
                </View>
              </View>
            );
              ...
              <View style={styles.pickerContainer}>
                {hotelRooms.map((room) => (
                  <TouchableOpacity
                    ...
                    style={[
                      styles.pickerItem,
                      selectedRoomTypeId === room.roomTypeId && styles.pickerItemActive,
                    ]}
                  ...
                  >
                    <Text
                      style={[
                        ...
                        selectedRoomTypeId === room.roomTypeId && styles.pickerItemTextActive,
                      ]}
                    >
                      {room.name}
                    </Text>
