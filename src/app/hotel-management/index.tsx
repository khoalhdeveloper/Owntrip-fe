            ...
            <View style={styles.statCard}>
              ...
              >
                ...
                <Text style={styles.statValue}>
                  {hotels.reduce((s, h) => s + (h.rooms?.length || 0), 0)}
                </Text>
            ...
            <View style={styles.statCard}>
              ...
              >
                ...
                <Text style={styles.statValue}>
                  {hotels.length > 0
                    ? (
                        hotels.reduce((s, h) => s + (h.reviewSummary?.score || 0), 0) /
                        hotels.length
                      ).toFixed(1)
                    : '—'}
                </Text>
        ...
        {hotels.length === 0 ? (
          <View style={styles.emptyState}>
            ...
            <Text style={styles.emptyDesc}>
              Liên hệ Admin để được thêm khách sạn vào tài khoản của bạn
            </Text>
          </View>
        ) : (
                  ...
                  {hotel.rooms?.[0] && (
                    <>
                      ...
                      <View style={styles.quickStat}>
                        ...
                        <Text style={styles.quickStatText}>
                          {formatPrice(
                            Math.min(...hotel.rooms.map((r) => r.basePrice || r.price || 0)),
                          )}
                          đ
                        </Text>
                      </View>
