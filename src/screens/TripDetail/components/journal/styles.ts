...
export const styles = StyleSheet.create({
  ...
  directionCardContent: { flexDirection: 'row', alignItems: 'center', gap: 10 },
  directionCardImg: { width: 44, height: 44, borderRadius: 12 },
  directionCardImgPlaceholder: {
    backgroundColor: '#F3F4F6',
    justifyContent: 'center',
    alignItems: 'center',
  },
  directionCardInfo: { flex: 1, gap: 2 },
  directionCardName: { fontSize: 14, fontWeight: '700', color: '#1A1A1A' },
  directionCardMeta: { flexDirection: 'row', alignItems: 'center', gap: 4 },
  directionCardMetaText: { fontSize: 11, color: '#9CA3AF' },
  directionCardBtns: { flexDirection: 'row', gap: 8 },
  directionBtn: {
    flex: 1,
    flexDirection: 'row',
    alignItems: 'center',
  ...
  sheetDaySeparatorDot: {
    width: 6,
    height: 6,
    borderRadius: 3,
  },
  sheetDaySeparatorText: {
    fontSize: 12,
    fontWeight: '700',
  },

  /* ── Mapbox GL Custom Marker Styles ── */
